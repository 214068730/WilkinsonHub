...
import runningshop.assignment6.factories.shop.ShopAddressFactory;
import runningshop.assignment6.factories.shop.ShopFactory;
...
public class TestShop {
    ...
    public void testCreateShop() throws Exception {
        ...
        Shop shop = ShopFactory.getShop("S001", "Bev's Trendy Shop", shopAddress);
